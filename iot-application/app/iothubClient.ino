...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool fallAlert)
{
    ...
    else
    {
        ...
        Map_Add(properties, "fallAlert", fallAlert ? "true" : "false");
...
void start()
{
    Serial.println("Start sending movement data.");
    messageSending = true;
}

void stop()
{
    Serial.println("Stop sending movement data.");
